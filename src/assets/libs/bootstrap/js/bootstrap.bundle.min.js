...
class ft extends W {
    ...
    show() {
        ...
        let t = [];
        if (this._config.parent && (t = this._getFirstLevelChildren(".messenger-collapse.show, .messenger-collapse.collapsing").filter((t => t !== this._element)).map((t => ft.getOrCreateInstance(t, {toggle: !1})))), t.length && t[0]._isTransitioning) return;
        if (P.trigger(this._element, "show.bs.messenger-collapse").defaultPrevented) return;
        ...
        this._queueCallback((() => {
            this._isTransitioning = !1, this._element.classList.remove(ct), this._element.classList.add(lt, at), this._element.style[e] = "", P.trigger(this._element, "shown.bs.messenger-collapse")
        }), this._element, !0), this._element.style[e] = `${this._element[i]}px`
    }

    hide() {
        if (this._isTransitioning || !this._isShown()) return;
        if (P.trigger(this._element, "hide.bs.messenger-collapse").defaultPrevented) return;
        ...
        this._isTransitioning = !0, this._element.style[t] = "", this._queueCallback((() => {
            this._isTransitioning = !1, this._element.classList.remove(ct), this._element.classList.add(lt), P.trigger(this._element, "hidden.bs.messenger-collapse")
        }), this._element, !0)
    }
    ...
    _getFirstLevelChildren(t) {
        const e = z.find(":scope .messenger-collapse .messenger-collapse", this._config.parent);
...
P.on(document, "click.bs.messenger-collapse.data-api", ht, (function (t) {
...
const Ve = Object.freeze(Object.defineProperty({
    ...
    Ye = "click.bs.messenger-dropdown.data-api", Ue = "keydown.bs.messenger-dropdown.data-api", Ge = "show",
    Je = '[data-bs-toggle="messenger-dropdown"]:not(.disabled):not(:disabled)', Ze = `${Je}.show`, ti = ".messenger-dropdown-menu",
...
class ci extends W {
    ...
    show() {
        ...
        if (!P.trigger(this._element, "show.bs.messenger-dropdown", t).defaultPrevented) {
            ...
            this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Ge), this._element.classList.add(Ge), P.trigger(this._element, "shown.bs.messenger-dropdown", t)
        }
    }
    ...
    _completeHide(t) {
        if (!P.trigger(this._element, "hide.bs.messenger-dropdown", t).defaultPrevented) {
            if ("ontouchstart" in document.documentElement) for (const t of[].concat(...document.body.children)) P.off(t, "mouseover", h);
            this._popper && this._popper.destroy(), this._menu.classList.remove(Ge), this._element.classList.remove(Ge), this._element.setAttribute("aria-expanded", "false"), H.removeDataAttribute(this._menu, "popper"), P.trigger(this._element, "hidden.bs.messenger-dropdown", t)
        }
    }
    ...
    _selectMenuItem({key: t, target: e}) {
        const i = z.find(".messenger-dropdown-menu .messenger-dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t => a(t)));
...
P.on(document, Ue, Je, ci.dataApiKeydownHandler), P.on(document, Ue, ti, ci.dataApiKeydownHandler), P.on(document, Ye, ci.clearMenus), P.on(document, "keyup.bs.messenger-dropdown.data-api", ci.clearMenus), P.on(document, Ye, Je, (function (t) {
...
class _n extends W {
    ...
    _activateParents(t) {
        if (t.classList.contains("dropdown-item")) z.findOne(".messenger-dropdown-toggle", t.closest(".messenger-dropdown")).classList.add(fn); else for (const e of z.parents(t, ".nav, .list-group")) for (const t of z.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(fn)
    }
...
const bn = "ArrowLeft", vn = "ArrowRight", yn = "ArrowUp", wn = "ArrowDown", An = "active", En = "fade", Tn = "show",
    ...
    On = `.nav-link:not(.messenger-dropdown-toggle), .list-group-item:not(.messenger-dropdown-toggle), [role="tab"]:not(.messenger-dropdown-toggle), ${Cn}`;
...
class xn extends W {
    ...
    _toggleDropDown(t, e) {
        ...
        n(".messenger-dropdown-toggle", An), n(".messenger-dropdown-menu", Tn), i.setAttribute("aria-expanded", e)
    }
